...
df_peta_selected_year.geometry.to_crs(epsg=4326).to_json()

def make_choropleth(input_df, input_id, input_columne):
...
with col[0]:
    ...
    choropleth = make_choropleth(df_peta_selected_year, 'id', 'KEJADIAN')
