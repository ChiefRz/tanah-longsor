...
#######################
# Load data
all_rekap = pd.read_csv('all_rekap.csv')
all_peta = gpd.read_file('all_peta.shp')
...
with st.sidebar:
    ...
    df_selected_year_sorted = all_rekap.sort_values(by="KEJADIAN", ascending=False)
...
with col[0]:
    ...
    df_population_difference_sorted = calculate_population_difference(df_rekap_selected_year, selected_year)
